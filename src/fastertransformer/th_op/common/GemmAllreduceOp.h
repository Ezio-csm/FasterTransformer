...
struct GemmAllreduceOp: th::jit::CustomClassHolder {
    ...
    GemmAllreduceOp(int64_t _streamNum);
    ~GemmAllreduceOp();

    void GemmAllreduce(const th::Tensor& m1, const th::Tensor& m2, th::Tensor& m1m2,
                                    int64_t M, int64_t N, int64_t K);

    template<typename T1, typename T2>
    void GemmAllreduceDo(const th::Tensor& m1, const th::Tensor& m2, th::Tensor& m1m2, const T2& alpha, const T2& beta,
